...
#define wifi_ssid "atuarede"
#define wifi_password "atuapasswordwifi"

#define mqtt_server "ip_do_mqtt_server"
#define mqtt_user "username_mqtt_server"  //user do mosquito
#define mqtt_password "password_mqtt" //password mqtt mosquito

#define temperature_topic "dht11/topic/temp1"  //Topic températura
#define humidity_topic "dht11/topic/humidade1"        //Topic humiddade
...
#define DHTPIN D6    // Pin sur lequel est branché le DHT
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP8266Client", mqtt_user, mqtt_password)) {
      ...
      Serial.println(" On attend 3 secondes avant de recommencer");
      delay(3000);
    }
  }
}
